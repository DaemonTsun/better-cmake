...
macro(unversion_target_variables NAME VNAME)
    ...
    _unversion_variable(${NAME} ${VNAME} _COMPILE_FLAGS)
    _unversion_variable(${NAME} ${VNAME} _LINK_FLAGS)
...
macro(add_target_compile_flags TARGET)
    ...
    if (_ADD_TARGET_COMPILE_FLAGS_Default)
        if (CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
            list(APPEND "${TARGET}_COMPILE_FLAGS" "-fno-unwind-tables")
